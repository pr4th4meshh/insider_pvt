  ...
  return (
    <div className='bg-[#0c172f] h-auto ' >
      <div className='flex xxs:px-[10px] sm:px-[50px] lg:px-[120px] py-[62px] lg:flex-row xxs:flex-col-reverse xxs:items-center' >
        ...
        <img src=" /assets/playstore1.svg" className='mr-4 border border-white rounded-lg transition ease-in-out hover:-translate-y-1 hover:scale-110' alt="" />
        <img src=" /assets/playstore2.svg" className='mr-4 border border-white rounded-lg transition ease-in-out hover:-translate-y-1 hover:scale-110' alt="" />
        </div>
        </div>
        <div className="flex flex-1 justify-end ">
          <img src=" /assets/installhero1.gif" className='w-[320px] h-[320px] xxs:pb-12 lg:pb-0 ' alt="" />
        </div>
      </div>
    </div>
  )
